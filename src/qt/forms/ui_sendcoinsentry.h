...
public:
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QCoreApplication::translate("SendCoinsEntry", "The Doichain address to send the payment to", nullptr));
...
#if QT_CONFIG(tooltip)
        messageTextLabel->setToolTip(QCoreApplication::translate("SendCoinsEntry", "A message that was attached to the doichain: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Doichain network.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
