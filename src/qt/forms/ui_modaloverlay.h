...
"QLabel { color: rgb(40,40,40);  }"));
    ...
    void retranslateUi(QWidget *ModalOverlay)
    {
        ...
        infoText->setText(QCoreApplication::translate("ModalOverlay", "Recent transactions may not yet be visible; therefore your wallet's balance and name inventory might be incorrect, and name lookups are disabled. This information will be correct, and name lookups will be enabled, once your wallet has finished synchronizing with the Doichain network, as detailed below.", nullptr));
        infoTextStrong->setText(QCoreApplication::translate("ModalOverlay", "Attempting to spend doichains or update names that are affected by not-yet-displayed transactions will not be accepted by the network.", nullptr));
