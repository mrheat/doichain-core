...
public:
    ...
    void setupUi(QDialog *ReceiveRequestDialog)
    {
        ...
        uri_content->setText(QString::fromUtf8("doichain:DC1..."));
        ...
        address_content->setText(QString::fromUtf8("dc1..."));
        ...
        amount_content->setText(QString::fromUtf8("0.00000000 DOI"));
    ...
    {
        ReceiveRequestDialog->setWindowTitle(QCoreApplication::translate("ReceiveRequestDialog", "Request payment to ...", nullptr));
